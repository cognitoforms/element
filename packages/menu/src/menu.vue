<script type="text/jsx">
  ...
  import Menubar from '@cognitoforms/element-ui/src/utils/menu/aria-menubar';
  import { addClass, removeClass, hasClass } from '@cognitoforms/element-ui/src/utils/dom';

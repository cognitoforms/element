...
<script type="text/babel">
  ...
  import { isDate, range, nextDate, getDayCountOfYear } from '@cognitoforms/element-ui/src/utils/date-util';
  import { arrayFindIndex, coerceTruthyValueToArray } from '@cognitoforms/element-ui/src/utils/util';

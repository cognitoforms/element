...
<script>
import Popper from '@cognitoforms/element-ui/src/utils/vue-popper';
...
import ElTag from '@cognitoforms/element-ui/packages/tag';
import ElScrollbar from '@cognitoforms/element-ui/packages/scrollbar';
import ElCascaderPanel from '@cognitoforms/element-ui/packages/cascader-panel';
import AriaUtils from '@cognitoforms/element-ui/src/utils/aria-utils';
import { t } from '@cognitoforms/element-ui/src/locale';
import { isEqual, isEmpty, kebabCase } from '@cognitoforms/element-ui/src/utils/util';
import { isUndefined, isFunction } from '@cognitoforms/element-ui/src/utils/types';
import { isDef } from '@cognitoforms/element-ui/src/utils/shared';
import { addResizeListener, removeResizeListener } from '@cognitoforms/element-ui/src/utils/resize-event';
